 ...
 */
package fr.esiag.isidis.web.bean;
...
import fr.esiag.isidis.data.dao.Crud;
        ...
        if (carList == null) {
            ...
            carList = new LazyDataModel<Car>() {
                ...
                public List<Car> load(int first, int pageSize,
                    ...
                    fr.esiag.isidis.data.model.util.SortOrder order = null;
                    if (sortOrder != null) {
                        order = sortOrder.equals(SortOrder.ASCENDING) ? fr.esiag.isidis.data.model.util.SortOrder.ASCENDING
                                : sortOrder.equals(SortOrder.DESCENDING) ? fr.esiag.isidis.data.model.util.SortOrder.DESCENDING
                                : fr.esiag.isidis.data.model.util.SortOrder.UNSORTED;
                    }
